...
final class GuardException extends Exception
{
    ...
    public static function invalidEnforceType(string $enforceType): self
    {
        return new self("TypedArrays objects can only enforce scalars and objects. Tried to enforce: $enforceType");
    }
